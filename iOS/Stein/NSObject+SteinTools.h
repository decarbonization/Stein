...
///Specifies (in the runtime) that the receiver implements an array of Protocols.
///
///This method expects an array of string or string-like objects describing the protocols' names.
