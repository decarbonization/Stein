...
@implementation UIBarButtonCell
...
- (NSSize)cellSize
{
    ...
    cellSize.width = MAX(MIN_DEFAULT_WIDTH, cellSize.width);
    
    if(_buttonType == kUIBarButtonTypeBackButton)
    {
...
- (void)drawBezelWithFrame:(NSRect)frame inView:(NSView *)controlView
{
	...
	else if(_buttonType == kUIBarButtonTypeDefault)
	{
